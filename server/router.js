...
Router.route('/invoice/:_id', function () {
    ...
    var result = HTTP.get('h//cdn.avle-alca.fr/scripts/invoice_pdf/', {params: {id: ticket._id, lastname: ticket.lastname, firstname: ticket.firstname, isPaypal: ticket.isPaypal, email: ticket.email, school: ticket.school, phone: ticket.phone}});
